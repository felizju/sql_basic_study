...
SELECT 
    ...
    SUBSTR('SQL Developer', 2, 5), -- 문자열 자름 1번부터 3개자름 (첫글자가 1번)
...
-- NVL2(expr1, expr2, expr3)
    -- expr1 값이 Null이 아니면 expr2를 반환, Null이면 expr3를 반환 
SELECT
    emp_nm,
...
SELECT
    NULLIF('박찬호', '박찬호') -- 같으면 Null 리턴
FROM tb_emp;

SELECT
    NULLIF('박찬호', '박지성') -- 다르면 expr1인 박찬호 리턴
FROM tb_emp;
...
SELECT
    COALESCE(7000, NULL, NULL, NULL, 5000)
FROM dual;
